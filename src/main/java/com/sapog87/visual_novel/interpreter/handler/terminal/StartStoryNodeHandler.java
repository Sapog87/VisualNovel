...
import com.sapog87.visual_novel.core.story.nodes.StartStoryNode;
...
@Component
public class StartStoryNodeHandler implements StoryNodeHandler<NodeWrapper> {
    @Override
